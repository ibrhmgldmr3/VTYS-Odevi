        ...
        private void airButton2_Click(object sender, EventArgs e)
        {
            using (NpgsqlConnection conn = new NpgsqlConnection(baglanti))
            {
                try
                {
                    ...
                    string query1 = "INSERT INTO public.\"kisi\" (\"ad\", \"soyad\", \"tckn\", \"dogumtarihi\",\"cinsiyet\",\"telefon\",\"sifre\",\"kisituru\") VALUES (@ad, @soyad, @tckn, @dogumtarihi,@cinsiyet,@telefon,@sifre,@kisituru)";
                    NpgsqlCommand npgsqlCommand = new NpgsqlCommand(query1, conn);

                    // Parametreleri ekleyin
                    npgsqlCommand.Parameters.AddWithValue("@ad", dreamTextBox4.Text); // aloneTextBox1 TextBox'ınızın adı olabilir
